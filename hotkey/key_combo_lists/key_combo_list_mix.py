...
class KeyComboListMix(KeyComboListInterface):
    ...
    def _get(self) -> list[KeyCombo]:
        return [
            ...
            # ---------------------------------------------------------------------
            # s
            KeyCombo(mode=Mode(), key=Key(specific="s"),
            ...
            # ---------------------------------------------------------------------
            # alt + 1
            KeyCombo(mode=Mode(alt=True), key=Key(specific="1"),
                      legend=["Nautilus: Show TAB #1.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # alt + 2
            KeyCombo(mode=Mode(alt=True), key=Key(specific="2"),
            ...
            # ctrl + h
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="h"),
                      legend=["Nautilus: Toggle showing hidden files.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + k
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="k"),
                      legend=["Google Document: Add a link.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + l
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="l"),
                      legend=["Chrome: Focus on address bar.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + n
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="n"),
                      legend=[
            ...
            # ctrl + o
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="o"),
                      legend=["Obsidian: Open a note.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + r
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="r"),
            ...
            # ctrl + enter
            KeyCombo(mode=Mode(ctrl=True), key=Key(enter=True),
                      legend=[
            ...
            # ---------------------------------------------------------------------
            # shift + tab
            KeyCombo(mode=Mode(shift=True), key=Key(tab=True),
            ...
            # shift + ` = ~
            KeyCombo(mode=Mode(shift=True), key=Key(specific="`"),
            ...
            # ctrl + shift + f
            KeyCombo(mode=Mode(ctrl=True, shift=True), key=Key(specific="f"),
                      legend=["Obsidian: Search.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + shift + n
            KeyCombo(mode=Mode(ctrl=True, shift=True), key=Key(specific="n"),
                      legend=[
            ...
            # ctrl + shift + r
            KeyCombo(mode=Mode(ctrl=True, shift=True), key=Key(specific="r"),
                      legend=["Pinta: Resize the canvas (= expand the canvas).", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + shift + v
            KeyCombo(mode=Mode(ctrl=True, shift=True), key=Key(specific="v"),
                      legend=["Obsidian: [CUSTOM]: Open a vault.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + shift + x
            KeyCombo(mode=Mode(ctrl=True, shift=True), key=Key(specific="x"),
            ...
            # ---------------------------------------------------------------------
            # ctrl + alt + c
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="c"),
                      legend=["Google Document: Copy formatting to clipboard.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + alt + v
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="v"),
                      legend=["Google Document: Paste formatting from clipboard.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + alt + x
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="x"),
                      legend=["Pinta: Auto crop.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + alt + 0
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="0"),
                      legend=["Google Document: Apply `Normal Text`.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + alt + 1
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="1"),
                      legend=["Google Document: Apply `Normal Heading 1`.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + alt + 2
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="2"),
                      legend=["Google Document: Apply `Normal Heading 2`.", ],
                      weight=self.WEIGHT_NORMAL,
                      ),
            # ctrl + alt + 3
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="3"),
