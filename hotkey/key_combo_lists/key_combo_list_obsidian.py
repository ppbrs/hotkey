    ...
    def _get(self) -> list[KeyCombo]:
        return [
            ...
            KeyCombo(
                ...
                key=Key(specific="b"),
                legend=[
                    f"CUSTOM: Show {colored('Backlinks', attrs=['bold'])}.",
                ],
            ),
            # alt + c
            KeyCombo(
                ...
                key=Key(specific="c"),
                legend=[
                    f"CUSTOM: Toggle {colored('CODE', attrs=['bold'])}.",
                ],
            ),
            # alt + h
            KeyCombo(
                ...
                key=Key(specific="h"),
                legend=[
                    f"CUSTOM: Toggle {colored('HIGHLIGHT', attrs=['bold'])}.",
                ],
            ),
            # alt + o
            KeyCombo(
                ...
                key=Key(specific="o"),
                legend=[
                    f"CUSTOM: Show {colored('Outgoing links', attrs=['bold'])}.",
                ],
            ),
            # alt + p
            KeyCombo(
                ...
                key=Key(specific="p"),
                legend=[
                    f"CUSTOM: Toggle {colored('PIN', attrs=['bold'])} 📌.",
                ],
            ),
            # ---------------------------------------------------------------------
            # alt_gr + ...
