...
class KeyComboListTerminal(KeyComboListInterface):
    ...
    def _get(self) -> list[KeyCombo]:
        return [
            ...
            # alt + f
            KeyCombo(mode=Mode(alt=True), key=Key(specific="f"),
            ...
            # ctrl + e
            KeyCombo(mode=Mode(ctrl=True), key=Key(specific="e"),
            ...
            # ctrl + shift + t
            KeyCombo(mode=Mode(ctrl=True, shift=True), key=Key(specific="t"),
            ...
            # ---------------------------------------------------------------------
            # ctrl + alt + T
            KeyCombo(mode=Mode(ctrl=True, alt=True), key=Key(specific="t"),
