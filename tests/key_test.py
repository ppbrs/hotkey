...
class KeyTest(unittest.TestCase):
    ...
    def test_digits(self) -> None:
        ...
        for _ in range(self.count):
            sut = Key(digits=True)
            self.assertTrue(
                sut.key in self.digits_list, "Key is not in valid range")
    ...
    def test_esc(self) -> None:
        ...
        for _ in range(self.count):
            sut = Key(esc=True)
            self.assertEqual(
                sut.key, "esc", "Key has wrong value")
    ...
    def test_backspace(self) -> None:
        ...
        for _ in range(self.count):
            ...
            self.assertEqual(
                sut.key, "backspace", "Key has wrong value")
    ...
    def test_enter(self) -> None:
        ...
        for _ in range(self.count):
            sut = Key(enter=True)
            self.assertEqual(
                sut.key, "enter", "Key has wrong value")
    ...
    def test_tab(self) -> None:
        ...
        for _ in range(self.count):
            sut = Key(tab=True)
            self.assertEqual(
                sut.key, "tab", "Key has wrong value")
    ...
    def test_compare(self) -> None:
        ...
        self.assertNotEqual(
            Key(esc=True), Key(backspace=True),
            "")
        self.assertNotEqual(
            Key(esc=True), Key(enter=True),
            "")
        self.assertNotEqual(
            Key(enter=True), Key(esc=True),
            "")
        self.assertNotEqual(
            Key(enter=True), Key(backspace=True),
            "")
        self.assertNotEqual(
            Key(backspace=True), Key(esc=True),
            "")
        self.assertNotEqual(
            Key(backspace=True), Key(enter=True),
            "")
